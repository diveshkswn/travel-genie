export const destinations = [
    ...
    cityRestaurant: [
      {
        ...
        restaurantDesc:
          "Indulge in an unforgettable culinary experience at The Fine Dining, where exquisite flavors and elegance unite. Savour an array of delectable dishes crafted by master chefs using the finest ingredients. The opulent ambiance and impeccable service make it the perfect setting for a memorable dining affair.",
        costFor2: 200,
      },
      {
        id: 2,
        restaurantName: "Savor's Haven",
        restaurantDesc:
          "Immerse yourself in a gastronomic journey at Savor's Haven. Delight your taste buds with a fusion of international cuisines, crafted with fresh and locally sourced ingredients. The warm and inviting atmosphere creates the perfect setting for a delightful dining experience.",
        costFor2: 150,
      },
    ],
    itinerary: [
      {
        day: 1,
        destination: "Central Park Exploration",
        destinationDesc:
          "Embark on a leisurely stroll through the enchanting Central Park, one of the most iconic green spaces in New York. Immerse yourself in its tranquil beauty as you pass by picturesque lakes, blooming gardens, and stunning sculptures. A perfect escape from the bustling city life, Central Park offers a rejuvenating experience for nature lovers and photographers alike.",
        destinationImgUrl:
          "https://www.planetware.com/photos-large/USNY/new-york-city-central-park-1.jpg",
      },
      {
        day: 2,
        destination: "Broadway Spectacular",
        destinationDesc:
          "Immerse yourself in the magic of Broadway with an awe-inspiring show that will leave you spellbound. Experience the glitz and glamour of live performances by world-class actors, dancers, and musicians. From timeless classics to cutting-edge productions, Broadway offers an unforgettable night of entertainment that will stay with you long after the curtain falls.",
        destinationImgUrl:
          "https://imaging.broadway.com/images/custom/w1200/111000-20.jpg",
      },
      {
        day: 3,
        destination: "Statue of Liberty Cruise",
        destinationDesc:
          "Embark on a scenic cruise to the majestic Statue of Liberty, a symbol of freedom and democracy. Marvel at the grandeur of Lady Liberty as you sail along the glistening waters of New York Harbor. Capture stunning views of the city skyline and enjoy an informative guided tour of this iconic monument.",
        destinationImgUrl:
    ...
    cityRestaurant: [
      {
        ...
        restaurantDesc:
          "Indulge in the art of sushi at Sushi Delight. Delicate, fresh, and expertly crafted, their sushi delights will take your taste buds on a journey. Experience the authentic flavors of Japan in a cozy and traditional setting.",
        costFor2: 100,
      },
      {
        id: 2,
        restaurantName: "Tempura Heaven",
        restaurantDesc:
          "Experience tempura perfection at Tempura Heaven. Crispy, light, and served with a variety of dipping sauces, their tempura dishes will leave you craving for more. The elegant ambiance and attentive service enhance the dining experience.",
        costFor2: 120,
      },
    ],
    itinerary: [
      {
        ...
        destinationDesc:
          "Start your journey with a visit to Senso-ji Temple, Tokyo's oldest temple. Immerse yourself in the serene atmosphere as you explore the intricately designed pagodas and witness traditional ceremonies. Don't forget to try your luck at the Omikuji fortune-telling.",
        destinationImgUrl:
          "https://upload.wikimedia.org/wikipedia/commons/4/42/Sensoji_Temple_%28Asakusa%2C_Tokyo%2C_Japan%29_2023-07-02.jpg",
      },
      {
        day: 2,
        destination: "Shibuya Crossing",
        destinationDesc:
          "Experience the vibrant energy of Shibuya Crossing, one of the busiest pedestrian crossings in the world. Marvel at the sea of people as they cross the intersection from all directions. Explore the trendy shops, cafes, and entertainment spots surrounding the crossing.",
        destinationImgUrl:
          "https://www.kcpinternational.com/wp-content/uploads/2023/04/Shibuya-Crossing-1024x684.jpg",
      },
      {
        day: 3,
        destination: "Meiji Shrine",
        destinationDesc:
          "Escape to tranquility at Meiji Shrine, nestled within a lush forest. Take a peaceful walk along the tree-lined paths and explore the beautifully adorned shrine buildings. Experience a slice of traditional Japan amid the modern city.",
        destinationImgUrl:
  ...
  },
  {
    ...
    cityRestaurant: [
      {
        id: 1,
        restaurantName: "Ganga View Cafe",
        restaurantDesc:
          "Relish the breathtaking view of the Ganges River while dining at Ganga View Cafe. Treat yourself to delicious vegetarian dishes that embrace the flavors of Indian cuisine. The serene ambiance complements the culinary experience.",
        costFor2: 15,
      },
      {
        id: 2,
        restaurantName: "Ayurvedic Bistro",
        restaurantDesc:
          "Experience the essence of Ayurveda in every dish at Ayurvedic Bistro. Savor organic and healing meals that cater to your well-being. The holistic environment promotes a sense of harmony and health.",
        costFor2: 20,
      },
    ],
    itinerary: [
      {
        day: 1,
        destination: "Triveni Ghat",
        destinationDesc:
          "Commence your cultural journey with a visit to Triveni Ghat, a sacred bathing spot on the banks of the Ganges River. Witness the Ganga Aarti ceremony in the evening, as devotees light lamps and offer prayers to the river. Experience the spiritual ambiance and immerse yourself in the rituals.",
        destinationImgUrl:
          "https://rishikeshdaytour.com/blog/wp-content/uploads/2022/09/Triveni-Ghat-Rishikesh-1.jpg",
      },
      {
        day: 2,
        destination: "Parmarth Niketan Ashram",
        destinationDesc:
          "Delve deeper into the spiritual side of Rishikesh with a visit to Parmarth Niketan Ashram. Attend yoga and meditation sessions to rejuvenate your mind and body. Explore the ashram's serene surroundings and participate in the evening Ganga Aarti, a soul-stirring experience.",
        destinationImgUrl:
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/15/26/d3/c0/parmarth-niketan-ashram.jpg?w=700&h=-1&s=1",
      },
      {
        day: 3,
        destination: "Beatles Ashram",
        destinationDesc:
          "Discover the historical Beatles Ashram, where the legendary band once meditated and composed songs. Explore the graffiti-covered walls and connect with the creativity that once flourished here. Bask in the tranquil environment and get inspired by the artistic vibes.",
        destinationImgUrl:
    ...
    cityRestaurant: [
      {
        ...
        restaurantDesc:
          "Experience a regal dining affair at The Royal Feast, where culinary excellence meets elegance. Savor exquisite dishes inspired by British traditions and global influences. The opulent setting and impeccable service ensure a dining experience fit for royalty.",
        costFor2: 250,
      },
      {
        id: 2,
        restaurantName: "Cultural Fusion",
        restaurantDesc:
          "Embark on a culinary journey around the world at Cultural Fusion. Delight in an array of international cuisines that celebrate London's diverse cultural heritage. The vibrant ambiance and flavorsome dishes make it a cultural treat for your taste buds.",
        costFor2: 180,
      },
    ],
    itinerary: [
      {
        ...
        destinationDesc:
          "Begin your cultural exploration at The British Museum, a treasure trove of art and artifacts from various civilizations. Marvel at ancient Egyptian mummies, Greek sculptures, and precious historical relics. The museum's vast collection offers insights into the world's cultural diversity.",
        destinationImgUrl:
      ...
      {
        day: 2,
        destination: "West End Theatre",
        destinationDesc:
          "Experience the magic of London's West End with a captivating theater performance. From classic plays to contemporary musicals, the West End offers a world-class entertainment experience. Be mesmerized by talented actors and the enchanting atmosphere of the theater district.",
        destinationImgUrl:
          "https://tourscanner.com/blog/wp-content/uploads/2023/01/West-End-theaters-London.jpg",
      },
      {
        day: 3,
        destination: "Tower of London",
        destinationDesc:
          "Step back in time at the Tower of London, an iconic fortress with a rich history. Explore its ancient walls and discover stories of kings, queens, and historic events. Be awed by the Crown Jewels, a symbol of royal power and opulence.",
        destinationImgUrl:
    ...
    cityRestaurant: [
      {
        ...
        restaurantDesc:
          "Indulge in a culinary delight at Himalayan Delights. Sample mouthwatering local delicacies inspired by the Himalayan flavors. The cozy ambiance and warm hospitality make it a perfect spot to relish authentic regional cuisine.",
        costFor2: 100,
      },
      {
        id: 2,
        restaurantName: "Nature's Retreat",
        restaurantDesc:
          "Experience a delightful culinary journey at Nature's Retreat. Savour a fusion of international cuisines using fresh, locally sourced ingredients. The restaurant's serene setting amidst nature adds to the dining pleasure.",
        costFor2: 120,
      },
    ],
    itinerary: [
      {
        day: 1,
        destination: "Solang Valley Trek",
        destinationDesc:
          "Embark on an exhilarating trek to the stunning Solang Valley. Surrounded by snow-capped peaks, the valley offers breathtaking vistas and adventurous trails. Capture the beauty of glaciers, meadows, and gushing streams as you trek through this natural wonder.",
        destinationImgUrl:
          "https://www.kurumatravels.com/wp-content/uploads/2019/02/vashist-jogni-waterfall-solang-valley-trekking-2-1.jpg",
      },
      {
        day: 2,
        destination: "Beas Kund Trek",
        destinationDesc:
          "Embark on a challenging yet rewarding trek to the Beas Kund. The glacial lake, surrounded by majestic mountains, is a sight to behold. The trek takes you through alpine forests, lush meadows, and rocky terrains, offering an unforgettable experience for nature enthusiasts.",
        destinationImgUrl:
          "https://images.prismic.io/indiahike/aabf067e-2746-4360-8848-292dedb74601_Beas+Kund_BK_Indiahikes_Jothiranjan_Day+01_+%281%29.jpg?auto=compress,format",
      },
      {
        day: 3,
        destination: "Hampta Pass Trek",
        destinationDesc:
          "Embark on an epic trek to Hampta Pass, a high-altitude mountain pass in the Himalayas. The trail takes you through dramatic landscapes, including lush valleys, river crossings, and glacial moraines. Reach the pass to witness breathtaking views of the surrounding peaks.",
        destinationImgUrl:
    ...
    cityRestaurant: [
      {
        ...
        restaurantDesc:
          "Embark on a flavorful adventure at Spice Route, where authentic Indian cuisine is celebrated. Delight your taste buds with a fusion of traditional recipes and regional delicacies, infused with a harmonious blend of spices. The elegant ambiance and attentive service create a memorable dining experience.",
        costFor2: 2500,
      },
      {
        id: 2,
        ...
        restaurantDesc:
          "Indulge in the delightful chaos of Chaat Bazaar, a street food haven offering an array of savory and tangy chaats. Experience the explosion of flavors as you savor golgappas, papdi chaat, aloo tikki, and more. Let the vibrant atmosphere and lip-smacking chaats leave you craving for more.",
        costFor2: 300,
      },
    ],
    itinerary: [
      {
        day: 1,
        destination: "Old Delhi Food Walk",
        destinationDesc:
          "Embark on a flavorful food walk through the bustling streets of Old Delhi. Explore the narrow lanes lined with food vendors, offering a diverse range of street delights. Indulge in local favorites like chole bhature, kebabs, and jalebis, along with refreshing lassi.",
        destinationImgUrl:
          "https://media.tacdn.com/media/attractions-splice-spp-674x446/06/6a/d8/62.jpg",
      },
      {
        day: 2,
        destination: "Dining at Spice Route",
        destinationDesc:
          "Savor the art of Indian gastronomy at Spice Route, a fine dining restaurant known for its exquisite Indian dishes. Relish the flavors of traditional curries, tandoori delights, and delectable desserts. Immerse yourself in the opulent ambiance inspired by ancient Indian trade routes.",
        destinationImgUrl:
          "https://www.wbpstars.com/wp-content/uploads/2021/02/The-Spice-Route-photo6017503dab97a-1440x810.jpg?v=1612180040",
      },
      {
        day: 3,
        destination: "Chaat Exploration at Chaat Bazaar",
        destinationDesc:
          "Embark on a delightful exploration of chaats at Chaat Bazaar, an iconic street food hub. Sample a variety of chaats, from crispy golgappas to tangy papdi chaat. Let your taste buds revel in the explosion of flavors, and soak in the lively atmosphere of this vibrant food paradise.",
        destinationImgUrl:
    ...
    cityRestaurant: [
      {
        ...
        restaurantDesc:
          "Savor the explosion of flavors at Spice Paradise. Experience authentic Indian spices in delectable dishes carefully crafted by skilled chefs. The warm ambiance and delightful aromas create a memorable dining experience.",
        costFor2: 150,
      },
      {
        id: 2,
        ...
        restaurantDesc:
          "Delight in the tantalizing taste of chaats at Chaat Corner. Experience a medley of tangy, spicy, and savory street food snacks that define Indian chaat culture. Treat your taste buds to an array of flavors.",
        costFor2: 50,
      },
    ],
    itinerary: [
      {
        ...
        destinationDesc:
          "Embark on a culinary journey at Chandni Chowk, Delhi's oldest and most famous market. Experience the delights of Indian street food, from spicy kebabs to mouthwatering sweets. Stroll through the bustling lanes and discover hidden treasures in the chaotic charm of this market.",
        destinationImgUrl:
          "https://images.hindustantimes.com/img/2021/09/12/550x309/89d4980c-13f6-11ec-8f84-d3748427d977_1631471245193.jpg",
      },
      {
        day: 2,
        destination: "Dilli Haat",
        destinationDesc:
          "Experience the cultural kaleidoscope of Dilli Haat, an open-air craft bazaar that showcases the diverse arts and crafts of India. Shop for traditional handicrafts, textiles, and souvenirs while savoring regional delicacies from different states.",
        destinationImgUrl:
          "https://www.hindustantimes.com/ht-img/img/2023/04/26/1600x900/Shoppers-at-a-Dilli-Haat-INA---Sanjeev-Verma-HT-Ph_1682531840596.jpg",
      },
      {
        day: 3,
        destination: "Connaught Place",
        destinationDesc:
          "Embark on a shopping spree at Connaught Place, Delhi's premier commercial and shopping district. Explore modern shopping malls, designer boutiques, and traditional emporiums. Indulge in a delightful meal at one of the many restaurants and cafes.",
  ...
  },
  {
    ...
    cityRestaurant: [
      {
        id: 1,
        restaurantName: "Palace Dine",
        restaurantDesc:
          "Savor regal dining at Palace Dine, where the essence of royalty meets culinary excellence. Relish in a fine selection of Rajasthani and Gujarati dishes, lovingly prepared with authentic flavors and premium ingredients. The palatial ambiance and impeccable service elevate the dining experience to a princely affair.",
        costFor2: 250,
      },
      {
        id: 2,
        restaurantName: "Culture Kitchen",
        restaurantDesc:
          "Embark on a culinary journey through the flavors of Rajasthan and Gujarat at Culture Kitchen. From traditional Thali spreads to delectable street food delights, this restaurant offers an authentic taste of the region's gastronomic heritage. The warm and rustic decor creates an inviting atmosphere for a delightful dining experience.",
        costFor2: 120,
      },
    ],
    itinerary: [
      {
        day: 1,
        destination: "Jaipur: Amber Fort",
        destinationDesc:
          "Step into the regal past as you visit the magnificent Amber Fort in Jaipur. Marvel at the grand architecture, intricate carvings, and panoramic views of the surrounding hills. Explore the majestic halls and pavilions, and learn about the history of this awe-inspiring fortress.",
        destinationImgUrl:
      ...
      },
      {
        ...
        destinationDesc:
          "Discover the royal opulence at the City Palace in Udaipur. Immerse yourself in the elegant courtyards, mirrored halls, and serene lakeside views. Witness the rich heritage of the Mewar dynasty and its contributions to art and culture.",
        destinationImgUrl:
          "https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Udaipur_City_Palace.jpg/1200px-Udaipur_City_Palace.jpg",
      },
      {
        day: 3,
        destination: "Ahmedabad: Sabarmati Ashram",
        destinationDesc:
          "Visit the iconic Sabarmati Ashram in Ahmedabad, the former residence of Mahatma Gandhi. Experience the simplicity and profound impact of Gandhian principles. Learn about India's freedom struggle and the philosophy of non-violence.",
        destinationImgUrl:
    ...
    cityRestaurant: [
      {
        ...
        restaurantDesc:
          "Experience the flavors of Africa at Savannah Grill. Indulge in mouthwatering dishes inspired by traditional African cuisine. The restaurant's warm ambiance and captivating decor create an unforgettable dining experience.",
        costFor2: 120,
      },
      {
        id: 2,
        restaurantName: "Wilderness Campfire",
        restaurantDesc:
          "Delight in a unique dining experience under the starlit African sky at Wilderness Campfire. Enjoy a delectable feast prepared by skilled chefs, accompanied by the sounds of the wilderness around you.",
        costFor2: 150,
      },
    ],
    itinerary: [
      {
        day: 1,
        destination: "Serengeti Game Drive",
        destinationDesc:
          "Embark on an exhilarating game drive through Serengeti's vast plains. Witness herds of wildebeest, zebras, and gazelles in their natural habitat. Keep an eye out for the majestic predators like lions, cheetahs, and leopards that roam freely.",
        destinationImgUrl:
          "https://static.toiimg.com/thumb/msid-92721827,width-748,height-499,resizemode=4,imgsize-132048/.jpg",
      },
      {
        day: 2,
        destination: "Balloon Safari",
        destinationDesc:
          "Experience the Serengeti from a whole new perspective with a breathtaking hot air balloon safari. Soar above the landscapes and witness the sunrise over the African plains. Enjoy the stunning views of wildlife from the sky.",
        destinationImgUrl:
          "https://i.pinimg.com/originals/61/93/ee/6193ee19de6708b6f0d8738686fb2bda.jpg",
      },
      {
        day: 3,
        destination: "Ngorongoro Crater",
        destinationDesc:
          "Embark on an exciting adventure to Ngorongoro Crater, a UNESCO World Heritage site. Explore the world's largest inactive, intact volcanic caldera and witness an abundance of wildlife, including elephants, rhinos, and flamingos.",
        destinationImgUrl:
