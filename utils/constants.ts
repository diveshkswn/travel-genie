...
export const constants = {
  ...
  ITINERAY_PROMPT: "Please provide me {num_of_days} days itineray to visit in {city} that is famous for {selectedActivities} in the exact below JSON format [{day: number,destination,destinationDesc,morning: [{placeName, activity, from_time, to_time}],afternoon: [{placeName, activity, from_time, to_time}],evening: [{placeName, activity, from_time, to_time}]}]",
  SEARCH_PROMPT: "Please provide me itineray to visit in {user_input} in the exact below JSON format [{day: number,cityName,country,cityOverview,destination,destinationDesc,morning: [{placeName, activity, from_time, to_time}],afternoon: [{placeName, activity, from_time, to_time}],evening: [{placeName, activity, from_time, to_time}]}] with default 3 days"
}