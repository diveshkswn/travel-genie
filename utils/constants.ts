...
export const constants = {
  ...
  ITINERAY_PROMPT: "Please provide me {num_of_days} days itineray to visit in {city} that is famous for {selectedActivities} in the below JSON format [{day,destination,destinationDesc,morning: [{placeName, activity, from_time, to_time}],afternoon: [{placeName, activity, from_time, to_time}],evening: [{placeName, activity, from_time, to_time}]}]",
  SEARCH_PROMPT: "Please provide me itineray to visit in {user_input} in the below JSON format [{day,cityName,country,cityOverview,destination,destinationDesc,morning: [{placeName, activity, from_time, to_time}],afternoon: [{placeName, activity, from_time, to_time}],evening: [{placeName, activity, from_time, to_time}]}]"
}